...
export function MyDevices() {
  ...
  const [devices, setDevices] = useState<AdminUserSession[] | null>(null)
  ...
  return (
    <div className="space-y-3" data-test-id="my-devices">
      <ul className="grid grid-cols-1 gap-2">
        {live.map((d) => (
          <li key={d.id} className="flex items-center justify-between gap-3 rounded-[12px] border border-border bg-card p-3">
