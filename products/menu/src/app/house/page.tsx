...
/**
 * iedora.com — the brand landing page. Lives inside the menu Next.js
 * app and is served when proxy.ts detects Host=iedora.com (rewrites
 * `/` → `/house`). One container, one design-system import, one
 * deploy surface for both sites.
 *
